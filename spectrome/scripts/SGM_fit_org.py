...
def optsgm_st(cdk,psd,rois_with_MEG,fvec,mica_micro_intensity,s):
    ...
    st = localstability_microintensity.local_stability(brain.ntf_params,mica_micro_intensity)
...
if __name__ == '__main__':
    ...
    # pool.close()
    res2 = np.array(res)
    np.savetxt("/data/rajlab1/user_data/parul/spectromeP_results/results_globalSGM/chang_tauiu200_stableg_macrostable_spatial_nodb/spectral_spatial_10weightedcorr_ind_allstable_microint.csv", res2, delimiter=",",header="taue, taui, alpha, speed, gei, gii, tauC, r_tot, r_psd, r_sp, sub, flag, status, success")
