...
if __name__ == '__main__':
    ...
    # pool.close()
    res2 = np.array(res)
    np.savetxt("/protected/data/rajlab1/user_data/parul/spectromeP_results/results_globalSGM/alpha_experiments/sleep_N2_orgSGM_relspec_roivolnorm_distccc.csv", res2, delimiter=",",header="taue, taui, alpha, speed, gei, gii, tauC, r_tot, r_psd, r_sp, sub, flag, status, success")
